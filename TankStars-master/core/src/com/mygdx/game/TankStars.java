...
public class TankStars extends Game {
		...
		public void create () {
			menu_music=Gdx.audio.newMusic(Gdx.files.internal("screens/menu_music.OGG"));
			menu_music.setLooping(true);
			menu_music.play();
			player1 = new Player(300.0f, new com.mygdx.game.resources.Tank(100.0f, new Vector3(0,0,0), null,0));
			player2 = new Player(300.0f, new com.mygdx.game.resources.Tank(100.0f, new Vector3(0,0,0), null,1));
